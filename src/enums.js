...
(function (GameEdition) {
    GameEdition[GameEdition["ZERO"] = 1] = "ZERO";
    GameEdition[GameEdition["FIRST"] = 2] = "FIRST";
    GameEdition[GameEdition["SECOND"] = 3] = "SECOND";
    GameEdition[GameEdition["THIRD"] = 4] = "THIRD";
    GameEdition[GameEdition["TPF"] = 5] = "TPF";
    GameEdition[GameEdition["FOURTH"] = 6] = "FOURTH";
    GameEdition[GameEdition["FIFTH"] = 7] = "FIFTH";
    GameEdition[GameEdition["FPF"] = 8] = "FPF";
})(GameEdition || (exports.GameEdition = GameEdition = {}));
var MovementType;
